...
OP_RESPONSE_PATH = "responses/qwen3.2_32b_responses_first500.jsonl"
...
async def process_dataset_in_batches(dataset, client, batch_size: int = 10):
    ...
    for i in range(0, len(dataset), batch_size):
        ...
        with open(OP_RESPONSE_PATH, 'a+', encoding='utf-8') as f:
...
async def main():
    ...
    client = AsyncOpenAI(
        api_key="5w0kcqE4.XoqP0e4crHwsP4PlPxqJk5XATBDkkdUY",
        base_url="https://model-lqzzo9xq.api.baseten.co/environments/production/sync/v1"
    )
