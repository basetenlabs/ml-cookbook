...
This example fine tunes [GPT OSS 20B](https://huggingface.co/openai/gpt-oss-20b) on the `winglian/pirate-ultrachat-10k` dataset using Axolotl with maximum sequence lengths of 16k. It uses Deepspeed ZeRO3 and sequence parallelism to shard the model parameters and sequences across 8 H100 GPUs.
...
* [ZeRO 3](https://www.deepspeed.ai/2021/03/07/zero3-offload.html)