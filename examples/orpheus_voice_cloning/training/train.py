...
def parse_args():
    ...
    parser.add_argument("--model_id", type=str, default="unsloth/orpheus-3b-0.1-ft", help="Name of the pre-trained Whisper model.")
    parser.add_argument("--dataset_name", type=str, default="kchatr/fish-and-chips", help="Name of the dataset to use for training.")
    ...
    parser.add_argument("--lora_bias", type=str, default="none", help="Bias type for LoRA.")
    parser.add_argument("--use_gradient_checkpointing", type=str, default="unsloth", help="True or 'unsloth' for very long context")
    ...
    parser.add_argument("--logging_steps", type=int, default=2, help="Number of steps between logging.")
    ...
    parser.add_argument("--hub_model_id", type=str, default="baseten-admin/orpheus_voice_cloning1", help="Hugging Face Hub model ID to push the trained model.")
