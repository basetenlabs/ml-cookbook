# Qwen3 30B Fine-Tuning with MS-Swift (Single Node)

This example fine-tunes the Qwen3 30B model using the MS-Swift framework with MegatronLM on a single node on Baseten.
...
```bash
truss train init --examples qwen3-30b-mswift-singlenode
cd qwen3-30b-mswift-singlenode
